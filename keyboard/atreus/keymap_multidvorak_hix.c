...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /*
   * 2: Soft Dvorak Layer 2
   */
  KEYMAP(
      KC_INS,  KC_HOME,      KC_UP,    KC_END,    KC_PGUP,                      KC_UP,   KC_F7,   KC_F8,      KC_F9,    KC_F10,
      KC_DEL,  KC_LEFT,      KC_DOWN,  KC_RIGHT,  KC_PGDN,                      KC_DOWN, KC_F4,   KC_F5,      KC_F6,    KC_F11,
      KC_FN7,  KC__VOLUP,    KC_NO,    KC_NO,     KC_FN30,                      KC_NO,   KC_F1,   KC_F2,      KC_F3,    KC_F12,
  ...
  /*
   * 5: Hard Dvorak Layer 2
   */
  KEYMAP(
      KC_INS,   KC_HOME,  KC_UP,    KC_END,    KC_PGUP,                      KC_UP,   KC_F7,   KC_F8,   KC_F9,  KC_F10,
      KC_DEL,   KC_LEFT,  KC_DOWN,  KC_RIGHT,  KC_PGDN,                      KC_DOWN, KC_F4,   KC_F5,   KC_F6,  KC_F11,
      KC_FN7,   KC_NO,    KC_NO,    KC_NO,     KC_FN30,                      KC_NO,   KC_F1,   KC_F2,   KC_F3,  KC_F12,
      KC_FN19,  KC_NO,    KC_LGUI,  KC_LSFT,   KC_BSPC,  KC_FN20,  KC_FN21,  KC_SPC,  KC_FN6,  KC_NO,   KC_NO,  KC_NO
      ),

  /*
   * 6: QWERTY Gaming Layer
   */
  KEYMAP(
      KC_1,  KC_2,  KC_3,  KC_4,  KC_5,                       KC_6,  KC_7,     KC_8,     KC_9,    KC_0,
      KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,                       KC_Y,  KC_U,     KC_I,     KC_O,    KC_P,
      KC_A,  KC_S,  KC_D,  KC_F,  KC_G,                       KC_H,  KC_J,     KC_K,     KC_L,    KC_SCLN,
      KC_Z,  KC_X,  KC_C,  KC_V,  KC_SPC,  KC_LSFT,  KC_TAB,  KC_N,  KC_FN19,  KC_COMM,  KC_DOT,  KC_SLSH
      )
